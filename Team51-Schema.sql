create table `ER-3`.Production_House
(
...
',
    ...
    constraint Movie_Production_House_Name_fk
        foreign key (Production_House_Name) references `ER-3`.Production_House (Name)
            on update cascade on delete cascade,
    check (Duration >= 0)
);
create table `ER-3`.TV_Series
(
    ID                    int          not null
        primary key,
...
(
    ...
    constraint Award_Movie_ID_fk
        foreign key (Movie_ID) references `ER-3`.Movie (ID)
            on delete cascade,
    constraint Award_Person_ID_fk
        foreign key (Person_ID) references `ER-3`.Person (ID)
            on delete cascade,
    constraint Award_TV_Series_ID_fk
        foreign key (TV_Series_ID) references `ER-3`.TV_Series (ID)
            on delete cascade
);

create table `ER-3`.User
(
...
create table `ER-3`.TV_Series_List
(
    UserName     varchar(100) not null,
    ListName     varchar(100) not null,
...
create table `ER-3`.Person_ActsIn_Movie
(
...
(
    ...
    constraint TV_Episode_TV_Series_ID_fk
        foreign key (Series_ID) references `ER-3`.TV_Series (ID)
            on update cascade on delete cascade
);



create table `ER-3`.`Person_ActsIn_TV-Episode`
(
    Person_ID     int not null,
    ...
    constraint `Person_ActsIn_TV-Episode_TV_Episode_ID_fk`
        foreign key (TV_Episode_ID) references `ER-3`.TV_Episode (ID),
    constraint `Person_ActsIn_TV-Episode_TV_Series_ID_fk`
        foreign key (TV_series_ID) references `ER-3`.TV_Series (ID)
);

create table `ER-3`.Person_Directs_Movie
(
    Person_ID int not null,
    Movie_ID  int not null,
    primary key (Person_ID, Movie_ID),
...
create table `ER-3`.`Person_Directs_TV-Episode`
(
    Person_ID     int not null,
    TV_Episode_ID int not null,
    TV_Series_ID  int not null,
    ...
    constraint `Person_Directs_TV-Episode_TV_Episode_Series_ID_fk`
        foreign key (TV_Series_ID) references `ER-3`.TV_Episode (Series_ID)
);

create table `ER-3`.Person_Writes_Movie
(
    Person_ID int not null,
    Movie_ID  int not null,
    primary key (Person_ID, Movie_ID),
...
create table `ER-3`.`Person_Writes_TV-Episode`
(
    Person_ID     int not null,
    TV_Episode_ID int not null,
    TV_Series_ID  int not null,
...
create table `ER-3`.Person_Phone
(
    Person_ID    int         not null
        primary key,
...
create table `ER-3`.User_Follows_User
(
    UserName1 varchar(100) not null,
    UserName2 varchar(100) not null,
    primary key (UserName1, UserName2),
    constraint User_Follows_User_User_UserName_fk
        foreign key (UserName1) references `ER-3`.User (UserName)
            on update cascade on delete cascade,
    constraint User_Follows_User_User_UserName_fk_2
        foreign key (UserName2) references `ER-3`.User (UserName)
            on update cascade on delete cascade
);

create table `ER-3`.User_Rates_Movie
(
    UserName varchar(100) not null,
    Movie_ID int          not null,
...
create table `ER-3`.User_Rates_TV_Episodes
(
    UserName      varchar(100) not null,
    TV_Episode_ID int          not null,
    Rating        float        not null,
...
create table `ER-3`.User_Rates_TV_Series
(
    UserName     varchar(100) not null,
    TV_Series_ID int          not null,
    Rating       float        not null,
...
create table `ER-3`.User_Reviews_Movie
(
    UserName varchar(100)  not null,
    Movie_ID int           not null,
...
create table `ER-3`.User_Reviews_TV_Episode
(
    UserName      varchar(100)  not null,
    TV_Episode_ID int           not null,
    Text          varchar(5000) not null,
...
create table `ER-3`.User_Reviews_TV_Series
(
    UserName     varchar(100)  not null,
    TV_Series_ID int           not null,
    Text         varchar(5000) not null,
